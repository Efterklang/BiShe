...
<template>
    <div class="max-w-7xl mx-auto">
        ...
        >
            ...
            <button
                v-if="activeTab === 'overview' && canManageTechnicians"
            ...
            >
                ...
                >
                    ...
                    <div class="flex flex-col items-center text-center mb-4">
                        <div
                            class="w-20 h-20 rounded-full bg-base-200 flex items-center justify-center text-2xl font-semibold text-base-content/60 mb-4 ring-4 ring-base-100 shadow-sm"
                        >
                        ...
                        <!-- Rating -->
                        <div
                            class="flex items-center gap-1 mt-1 text-warning text-sm font-medium"
                        >
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 24 24"
                    ...
                    <div class="flex-1">
                        <div class="flex flex-wrap gap-2 justify-center">
                            <span
                                v-for="(skill, idx) in parseSkills(
