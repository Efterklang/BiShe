    ...
    <div class="max-w-7xl mx-auto">
        ...
        >
            <div
                v-for="i in 6"
                :key="i"
                class="h-40 rounded-xl border border-base-300 bg-base-200 animate-pulse"
            ></div>
        </div>
            ...
            >
                <div class="flex justify-between items-start mb-4">
                    <div>
                        ...
                        <div
                            class="flex items-center gap-2 mt-1 text-sm text-base-content/60"
                        >
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                fill="none"
                    ...
                    <div class="text-right">
                        <span class="block text-xl font-bold text-base-content"
                            >¥{{ service.price }}</span
                        >
                    </div>
                </div>
                ...
                <div
                    class="mt-auto pt-4 border-t border-base-200 flex items-center justify-between"
                >
                    <div class="flex items-center gap-2">
                        <span class="relative flex h-2.5 w-2.5">
                            <span
                                v-if="service.is_active || service.IsActive"
                    ...
                    <form @submit.prevent="handleSubmit" class="space-y-5">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <div class="relative">
                                    <span
                                        class="absolute left-3 top-3 text-base-content/60"
                                        >¥</span
                                    >
                                    <input
                                        type="number"
