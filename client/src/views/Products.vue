			...
			<div v-for="product in products" :key="product.id"
				...
				<div class="card-body">
					<div class="flex items-start justify-between">
						...
						<div class="badge" :class="product.is_active ? 'badge-success' : 'badge-ghost'">
					...
					<div class="mt-4">
						<div class="flex items-center justify-between">
							...
							<div class="flex items-center gap-2">
								...
								<button @click="openInventoryModal(product)" class="btn btn-xs btn-ghost"
									title="查看库存记录">
					...
					<div class="card-actions justify-end mt-4 pt-4 border-t border-base-200">
						<button @click="openStockChangeModal(product, 'restock')"
							class="btn btn-sm btn-success btn-outline" title="入库">
							<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2"
						...
						<button @click="openStockChangeModal(product, 'sale')"
							class="btn btn-sm btn-warning btn-outline" title="出库">
							<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2"
								stroke="currentColor" class="w-4 h-4">
								<path stroke-linecap="round" stroke-linejoin="round"
						...
						<button v-if="canManageProducts" @click="handleEdit(product)" class="btn btn-sm btn-ghost">
							编辑
						</button>
						<button v-if="canManageProducts" @click="handleDelete(product.id)"
			...
			<div class="modal-box max-w-2xl">
				...
				<form @submit.prevent="handleSubmit" class="space-y-4">
					...
					<div class="modal-action">
						<button type="button" class="btn btn-ghost" @click="showModal = false" :disabled="submitting">
							取消
						</button>
		...
		<dialog class="modal" :class="{ 'modal-open': showStockModal }">
			<div class="modal-box">
				...
				<form @submit.prevent="handleStockChange" class="space-y-4">
					...
					<div class="modal-action">
						<button type="button" class="btn btn-ghost" @click="showStockModal = false"
							:disabled="submitting">
							取消
						</button>
